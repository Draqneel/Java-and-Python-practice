package singleton.enum_example.repositories;

import singleton.enum_example.interfaces.CrudDao;
import singleton.enum_example.models.User;
...
public enum  UsersRepository implements CrudDao<User> {
    INSTANCE;
